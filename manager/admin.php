    ...
    <div class="container" style="max-width:97% !important;">
       ...
       if(isset($_POST['changestatus'])){
        ...
        if($status==0){
           ...
           $update="UPDATE  nameserver  SET  status='$newstatus',updatedAt='$date'  WHERE id='$id' LIMIT 1  ";
  ...
  <div class="row py-5">
    <div class="col-12">
      ...
      <table id="example" class="table table-hover responsive nowrap" style="width:100%">
        ...
        $selectquesry="SELECT * FROM nameserver ";
        
         if(isset($_POST['filtersearch']) ){
               $postst=$_POST['filter'];
               
               if($postst !=3)
               $selectquesry="SELECT * FROM nameserver WHERE status='$postst' ";
         ...
         $status=$row[3];
          ...
          <tr>
            ...
            <td>
                ...
                Nameserver 1: <span style="font-weight:bold;"> <?php echo $data['ns1']; ?> </span>  <br/>
 Nameserver 2:  <span style="font-weight:bold;">  <?php echo $data['ns2']; ?></span>  <br/>
  Nameserver 3: <span style="font-weight:bold;"> <?php echo $data['ns3']; ?></span> <br/>
   Nameserver 4: <span style="font-weight:bold;"> <?php echo $data['ns4']; ?></span> <br/>
    Nameserver 5:<span style="font-weight:bold;">  <?php echo $data['ns5']; ?> </span><br/>
